...
import Lady from "../../images/dummy1.png";
import "./patientCol.css";

function PatientItem() {
  return (
    <div className="patList">
      <div className="imgCon">
        <img src={Lady} alt="" srcset="" height={48} width={48} />
        <div style={{ display: "flex", alignItems: "center", height: 48 }}>
          <p className="heading mt-4 mx-3">
            Emily Williams <p className="text">Female, 18</p>
          </p>
        </div>
      </div>{" "}
      <svg
